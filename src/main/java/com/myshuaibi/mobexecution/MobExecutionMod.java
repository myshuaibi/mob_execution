package com.myshuaibi.mobexecution;
...
public class MobExecutionMod {
	public static final Logger LOGGER = LogManager.getLogger(MobExecutionMod.class);
	public static final String MODID = "mob_execution";

	public MobExecutionMod(IEventBus modEventBus) {
